...
from src.schemas import RouteProposal, IncidentClassification, NegotiationResult, ExplainabilityInput
...
async def test_explainability_heuristics(sample_explain_input):
    ...
    with patch.dict(os.environ, {}, clear=True):
        ...
        sample_explain_input.negotiation_result.counterfactual["planned_eta_with_intervention"] = 11
...
async def test_explainability_llm_path(sample_explain_input):
    ...
    with patch.dict(os.environ, {"GEMINI_API_KEY": "dummy_key"}):
        ...
        assert res.reasoning_one_liner == "Surface Streets chosen: saves 14 mins, delays 12 cars."
