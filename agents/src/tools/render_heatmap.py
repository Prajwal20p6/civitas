...
def render_comparison(route_a_name: str, score_a: float,
                      route_b_name: str, score_b: float,
                      winner: str = None) -> str:
    """
    ...
    fig.suptitle("CIVITAS Congestion Simulation Comparison", fontsize=11, fontweight="bold", y=1.02)
    fig.tight_layout()
...
if __name__ == "__main__":
    ...
    comp = render_comparison("Surface Streets", 92, "Highway 1", 74, winner="route_a_speed_first")
